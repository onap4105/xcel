...
"""
Copyright Header Updater v1.4

Changes:
1. Consistent "shbang" spelling (no "shebang")
2. Check shbang before file extensions in get_language()
3. Replaced raise SystemExit(1) with sys.exit(1)
"""
...
def get_language(file_path: Path, config: Dict[str, Any]) -> Optional[str]:
    ...
    # Only check extension if shbang check failed
...
def parse_shbang(content: str) -> tuple:
